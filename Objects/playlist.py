...
class Playlist:
    ...
    def enrich_from_db(self):
        """Enriches playlist object details using local database"""
        pass  # TODO

    def enrich_from_json(self, json_data=None):
        """Enrich playlist object details from YT-DLP JSON data"""
    ...
    def get_json_data(self):
        """Gets playlist details from site using YT-DLP"""
        info_json = None
        while info_json is None:
            try:
                playlist_url = self.site.get_playlist_url(self.unique_id)
    ...
    def check(self):
        """Checks download state of the playlist"""
        pass  # TODO
